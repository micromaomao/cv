...
\renewcommand\section[1]{%
  ...
  \@startsection{section}{1}{\z@}{0.05\baselineskip plus 0.2em}{0.05\baselineskip}{\bfseries\MakeUppercase}*{\tlabel{}#1\makebox[0pt]{\posttlabel}}%
}
\makeatother
...
\setitemize{topsep=0em, itemsep=0.27\parskip, partopsep=0em, parsep=0.5\parskip}
