...
\begin{document}
  ...
  {%
    \centering\makebox[\textwidth]{%
      \begin{tikzpicture}[box/.style={inner ysep=6pt, inner xsep=4pt, draw=gray, rectangle, text width=0.483\textwidth, align=justify}]%
      \node[box] (n1) {%
        \begin{itemize}
          \setlength\itemsep{3pt}
          \item In-depth Azure cloud-native development
          \item Fluent: Python, Rust, C\#/.NET, C
          \item Git, Docker, Kubernetes, Grafana
          \item Linux development and administration
          \item Detailed knowledge of HTTP, TCP/IP, DNS, TLS
          \item Specification, design, architecture, security
        \end{itemize}
      };
      \node[color=black, fill=white, right=4pt of n1.north west, anchor=base west, yshift=-4pt] {%
        \textbf{Used at work}
      };
      \node[box, below right=0pt of n1.north east, xshift=10pt] (n2) {%
        \begin{itemize}
          \setlength\itemsep{3pt}
          \item Google Cloud and AWS.
          \item Fluent: JavaScript/TypeScript, Java, C++
          \item Front-end: React, Svelte (NextJS, SvelteKit)
          \item Back-end: ExpressJS, FastAPI, PostgreSQL, Redis
          \item 3D graphics, cryptography, algorithms
        \end{itemize}
      };
      \node[color=black, fill=white, right=4pt of n2.north west, anchor=base west, yshift=-4pt] {%
        \textbf{Significant personal experience}
      };
    \end{tikzpicture}}%
  }
  ...
  \begin{itemize}
    ...
    \begin{itemize}
      \item Worked in a fast-moving, agile team to develop an Azure service for real time AI driven phone scam detection.
