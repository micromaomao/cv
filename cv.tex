...
\begin{document}
  ...
  {%
    \centering\makebox[\textwidth]{%
      ...
      \node[color=black, fill=white, right=3pt of n1.north west] {%
        \textbf{At work}
      };
      \node[box, below right=0pt of n1.north east, xshift=10pt] (n2) {%
        \begin{itemize}
          ...
          \item Fluent: JavaScript/TypeScript, Rust, Java, C++
          \item Front-end: React, Svelte (NextJS, SvelteKit)
          \item Back-end: ExpressJS, FastAPI, PostgreSQL, Redis
          \item Cryptography, algorithms, 3D graphics
        \end{itemize}
      };
      \node[color=black, fill=white, right=3pt of n2.north west] {%
