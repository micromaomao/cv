...
\def\header{%
  \begin{tikzpicture}[every node/.style={inner ysep=0.1cm, inner xsep=0cm, anchor=north west}]
    ...
    \node (bio) at (name.south west) {Computer Science undergraduate at\uclicon{}UCL};
...
\begin{document}
  ...
  \begin{itemize}
    \item \ongoing{} \textbf{BSc Computer Science} \dashdiv{} University College London \dashdiv{} 2019-2022
      ...
      \begin{itemize}
        ...
        \item Design and Professional Skills: debugging, code style, algorithm, etc.
  ...
  \begin{itemize}
    ...
    \item \href{https://paper.sc}{\color{link}\textbf{paper.sc}} \ghurl{https://github.com/micromaomao/schsrch}: CIE past paper search engine \dashdiv{} 2016-2019
    ...
    \item \textbf{go-ecbpass} \ghurl{https://github.com/micromaomao/go-ecbpass}: deterministic pseudo-random password generator \dashdiv{} Oct 2018
