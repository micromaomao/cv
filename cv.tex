...
\def\header{%
  ...
  \begin{tikzpicture}[every node/.style={inner ysep=0.1cm, inner xsep=0cm, anchor=north west}]
    ...
    \node[font=\Large, inner ysep=0.187cm] (name) at (topleft) {Tingmao Wang};
    \node[inner ysep=0.1cm] (bio) at (name.south west) {%
    ...
    \node[anchor=north east, text width=0.4\textwidth, align=flush right, inner ysep=0cm, yshift=0.05cm] (contacts) at (topright)
      {{%
        ...
        \pencil{}:
        \href{https://blog.maowtm.org/linux-ick/en.html}{\color{link}kernel}, \href{https://blog.maowtm.org/ct/en.html}{\color{link}security}, \href{https://blog.maowtm.org/dpdk/en.html}{\color{link}DPDK}, and \href{https://blog.maowtm.org/}{\color{link}more}
        \\
      }};

    \coordinate (bottomleft) at ($(bio.south west)+(0, -0.15cm)$);
...
\begin{document}
  ...
  \begin{itemize}
    ...
    \item \href{https://leafvote.mww.moe}{\color{link}\textbf{Leafvote}} \ghurl{https://github.com/micromaomao/leafvote}: Live voting solution built with React and NodeJS used by 500+ people at my high school \dashdiv{} Aug 2018
