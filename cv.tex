...
\begin{document}
  ...
  \begin{itemize}
    ...
    % \begin{itemize}
    %   \item Based on Retrieval Augmented Generation, usingthe old Winterbells game OpenAI completion and embedding models, built as a Next.JS application with Fluent UI framework and PostgreSQL (Neon) as backend
    % \end{itemize}
